...
public class Vreemdeling implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "vreemdelings", allowSetters = true)
    ...
    public Vreemdeling verblijf(Verblijf verblijf) {
    ...
    public Vreemdeling toetsresultaat(Toetsresultaat toetsresultaat) {
